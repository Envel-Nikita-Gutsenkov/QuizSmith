...
const translations: Translations = {
  en: {
    ...
    'dashboard.myPageTemplates.heading': 'My Templates',
    'dashboard.myPageTemplates.create': 'Create New Template',
    'dashboard.myPageTemplates.noPageTemplates.title': 'No templates created yet',
    'dashboard.myPageTemplates.noPageTemplates.description': 'Build reusable quiz page designs and engines.',
    'dashboard.myPageTemplates.noPageTemplates.button': 'Create Your First Template',
    'dashboard.editTest': 'Edit Test',
    'dashboard.editPageTemplate': 'Edit Template',
    ...
    'myPageTemplates.noPageTemplates.description': 'Page templates (quiz engines) help you build quizzes faster with consistent and custom page designs and logic.',
    ...
    'editor.config.description': 'Define test name, select a page style (quiz engine template), and set the quiz end message.',
    'editor.config.testNameLabel': 'Test Name',
    'editor.config.testNamePlaceholder': 'e.g., General Knowledge',
    'editor.config.templateLabel': 'Page Style (Quiz Engine Template)',
    ...
    'editor.preview.iframeTitle': 'Live Preview',
    ...
    'editor.questions.allowMultipleAnswersLabel': 'Allow multiple correct selections',
    ...
    'editor.questions.dropTargetsLabel': 'Drop Targets (for Text-on-Text D&amp;D):',
    ...
    'editor.questions.selectCorrectDragItem': 'Select Correct Draggable Item (for Text-on-Text D&amp;D)',
    'editor.questions.noCorrectDragItem': 'None (visual only in template)',
    'editor.questions.categoriesLabel': 'Categories (for Categorization D&amp;D):',
    'editor.questions.addCategory': 'Add Category',
    'editor.questions.categoryNamePlaceholder': 'Category Name',
    'editor.questions.removeCategory': 'Remove Category',
    'editor.questions.assignToCategoryLabel': 'Assign Item to Category (for Categorization D&amp;D):',
    'editor.questions.selectCategoryPlaceholder': 'Select category for this item',
    'editor.questions.connectPairsLabel': 'Connect Pairs (Left to Right):',
    'editor.questions.addConnectPair': 'Add Pair',
    'editor.questions.connectLeftItemPlaceholder': 'Left Item Text',
    'editor.questions.connectRightItemPlaceholder': 'Right Item Text',
    'editor.questions.removeConnectPair': 'Remove Connect Pair',
    ...
    'editor.toast.templateNotSelectedErrorTitle': 'No Page Style Selected',
    'editor.toast.templateNotSelectedErrorDescription': 'Please select a Page Style Template before saving.',

    'pageTemplateEditor.new.pageTitle': 'New Quiz Engine Template',
    'pageTemplateEditor.new.pageTitleFromSource': 'New Quiz Engine Template (from {{sourceName}})',
    'pageTemplateEditor.edit.pageTitle': 'Edit Quiz Engine Template: {{templateIdOrName}}',
    'pageTemplateEditor.updatePreview': 'Update Preview',
    'pageTemplateEditor.saveTemplate': 'Save Quiz Engine Template',
    'pageTemplateEditor.unsavedDraftTooltip': 'Unsaved local draft exists. Save to clear.',
    'pageTemplateEditor.details.title': 'Quiz Engine Template Definition',
    'pageTemplateEditor.details.description': 'Define the HTML structure, CSS style, and JavaScript quiz engine of your reusable quiz page template.',
    'pageTemplateEditor.details.nameLabel': 'Template Name',
    'pageTemplateEditor.details.namePlaceholder': 'e.g., Modern MCQ Engine',
    'pageTemplateEditor.details.loadedNamePlaceholder': 'Quiz Engine Template {{templateId}}',
    'pageTemplateEditor.details.descriptionLabel': 'Description (Optional)',
    'pageTemplateEditor.details.descriptionPlaceholder': 'A brief description of this quiz engine template...',
    'pageTemplateEditor.details.htmlLabel': 'Page HTML Structure (Includes JS Quiz Engine)',
    'pageTemplateEditor.details.htmlPlaceholder': 'Enter template HTML. Include placeholders like &lt;div id="quiz-name-data"&gt;&lt;/div&gt; and &lt;script id="quiz-data"&gt;&lt;/script&gt; for data injection. All quiz logic must be within &lt;script&gt; tags here.',
    'pageTemplateEditor.details.htmlHint': 'Include &amp;lt;script&amp;gt; tags for all JS quiz logic. The script should read data from #quiz-data, #quiz-name-data, #quiz-end-message-data. Use placeholders like {{template_title_placeholder}} for editor preview only.',
    'pageTemplateEditor.details.cssLabel': 'Page CSS Styles',
    'pageTemplateEditor.details.cssPlaceholder': 'Enter template CSS...\n/* Style your template elements */\n/* Add your CSS animations here */',
    ...
    'pageTemplateEditor.preview.titlePane': 'Quiz Engine Template Preview',
    'pageTemplateEditor.preview.descriptionPane': 'This is how your template structure will look with sample content. The JS engine from your HTML will run here.',
    'pageTemplateEditor.preview.iframeTitle': 'Quiz Engine Template Preview',
    ...
    'pageTemplateEditor.toast.saveSuccessTitle': 'Quiz Engine Template Saved (Mock)',
    'pageTemplateEditor.toast.saveSuccessDescription': 'Quiz Engine Template "{{templateName}}" data logged to console.',
    'pageTemplateEditor.toast.saveSuccessTitleExisting': 'Existing Quiz Engine Template Saved (Mock)',
    'pageTemplateEditor.toast.saveSuccessDescriptionExisting': 'Quiz Engine Template {{templateName}} data logged to console.',
    'pageTemplateEditor.toast.draftRestoredTitle': 'Draft Restored',
    'pageTemplateEditor.toast.draftRestoredDescriptionNew': 'Your unsaved new quiz engine template draft has been loaded.',
    ...
    'pageTemplates.explore.useThisTemplate': 'Use This Engine',
    'pageTemplates.explore.preview': 'Edit Engine Template',
    'pageTemplates.explore.duplicate': 'Duplicate Engine',
    'pageTemplates.explore.noTemplates.title': 'No Quiz Engine Templates Available Yet',
    'pageTemplates.explore.noTemplates.description': 'Be the first to create a stunning quiz engine template for QuizSmith!',
    'pageTemplates.explore.noTemplates.button': 'Create Your First Quiz Engine Template',
    ...
    'questionType.categorization-drag-and-drop': 'Categorization (Drag &amp; Drop)',
    'questionType.connect-points-matching': 'Connect Points (Matching)',
  },
  ru: {
    ...
    'dashboard.myPageTemplates.heading': 'Мои шаблоны',
    'dashboard.myPageTemplates.create': 'Создать новый шаблон',
    'dashboard.myPageTemplates.noPageTemplates.title': 'Шаблоны еще не созданы',
    'dashboard.myPageTemplates.noPageTemplates.description': 'Создавайте многоразовые дизайны и движки для ваших викторин.',
    'dashboard.myPageTemplates.noPageTemplates.button': 'Создать первый шаблон',
    'dashboard.editTest': 'Редактировать тест',
    'dashboard.editPageTemplate': 'Редактировать шаблон',
    ...
    'myPageTemplates.noPageTemplates.description': 'Шаблоны страниц (движки викторин) помогут вам быстрее создавать викторины с единым и настраиваемым дизайном и логикой.',
    ...
    'editor.config.description': 'Задайте название теста, выберите стиль страницы (шаблон движка викторины) и сообщение о завершении викторины.',
    'editor.config.testNameLabel': 'Название теста',
    'editor.config.testNamePlaceholder': 'например, Общие знания',
    'editor.config.templateLabel': 'Стиль страницы (Шаблон движка викторины)',
    ...
    'editor.preview.iframeTitle': 'Живой предпросмотр',
    ...
    'editor.questions.allowMultipleAnswersLabel': 'Разрешить несколько правильных ответов',
    ...
    'editor.questions.dropTargetsLabel': 'Места для перетаскивания (для Текст-на-Текст D&amp;D):',
    ...
    'editor.questions.selectCorrectDragItem': 'Выберите правильный перетаскиваемый элемент (для Текст-на-Текст D&amp;D)',
    'editor.questions.noCorrectDragItem': 'Нет (только визуально в шаблоне)',
    'editor.questions.categoriesLabel': 'Категории (для D&amp;D Категоризации):',
    'editor.questions.addCategory': 'Добавить категорию',
    'editor.questions.categoryNamePlaceholder': 'Название категории',
    'editor.questions.removeCategory': 'Удалить категорию',
    'editor.questions.assignToCategoryLabel': 'Назначить элемент категории (для D&amp;D Категоризации):',
    'editor.questions.selectCategoryPlaceholder': 'Выберите категорию для этого элемента',
    'editor.questions.connectPairsLabel': 'Соединяемые пары (Слева направо):',
    'editor.questions.addConnectPair': 'Добавить пару',
    'editor.questions.connectLeftItemPlaceholder': 'Текст левого элемента',
    'editor.questions.connectRightItemPlaceholder': 'Текст правого элемента',
    'editor.questions.removeConnectPair': 'Удалить пару для соединения',
    ...
    'editor.toast.templateNotSelectedErrorTitle': 'Стиль страницы не выбран',
    'editor.toast.templateNotSelectedErrorDescription': 'Пожалуйста, выберите Стиль страницы (Шаблон движка викторины) перед сохранением.',

    'pageTemplateEditor.new.pageTitle': 'Новый шаблон движка викторины',
    'pageTemplateEditor.new.pageTitleFromSource': 'Новый шаблон движка викторины (из {{sourceName}})',
    'pageTemplateEditor.edit.pageTitle': 'Редактировать шаблон движка викторины: {{templateIdOrName}}',
    'pageTemplateEditor.updatePreview': 'Обновить предпросмотр',
    'pageTemplateEditor.saveTemplate': 'Сохранить шаблон движка викторины',
    'pageTemplateEditor.unsavedDraftTooltip': 'Существует несохраненный локальный черновик. Сохраните, чтобы очистить.',
    'pageTemplateEditor.details.title': 'Определение шаблона движка викторины',
    ...
    'pageTemplateEditor.details.namePlaceholder': 'например, Современный движок MCQ',
    'pageTemplateEditor.details.loadedNamePlaceholder': 'Шаблон движка викторины {{templateId}}',
    'pageTemplateEditor.details.descriptionLabel': 'Описание (необязательно)',
    'pageTemplateEditor.details.descriptionPlaceholder': 'Краткое описание этого шаблона движка викторины...',
    'pageTemplateEditor.details.htmlLabel': 'Структура HTML страницы (Включая JS-движок викторины)',
    'pageTemplateEditor.details.htmlPlaceholder': 'Введите HTML шаблона. Включите плейсхолдеры типа &lt;div id="quiz-name-data"&gt;&lt;/div&gt; и &lt;script id="quiz-data"&gt;&lt;/script&gt; для инъекции данных. Вся логика викторины должна быть в тегах &lt;script&gt; здесь.',
    'pageTemplateEditor.details.htmlHint': 'Включите теги &amp;lt;script&amp;gt; для всей JS логики викторины. Скрипт должен читать данные из #quiz-data, #quiz-name-data, #quiz-end-message-data. Используйте плейсхолдеры типа {{template_title_placeholder}} только для предпросмотра в редакторе.',
    ...
    'pageTemplateEditor.preview.titlePane': 'Предпросмотр шаблона движка викторины',
    'pageTemplateEditor.preview.descriptionPane': 'Так будет выглядеть структура вашего шаблона с образцом содержимого. JS-движок из вашего HTML будет запущен здесь.',
    'pageTemplateEditor.preview.iframeTitle': 'Предпросмотр шаблона движка викторины',
    ...
    'pageTemplateEditor.toast.saveSuccessTitle': 'Шаблон движка викторины сохранен (имитация)',
    'pageTemplateEditor.toast.saveSuccessDescription': 'Данные шаблона движка викторины "{{templateName}}" записаны в консоль.',
    'pageTemplateEditor.toast.saveSuccessTitleExisting': 'Существующий шаблон движка викторины сохранен (имитация)',
    'pageTemplateEditor.toast.saveSuccessDescriptionExisting': 'Данные шаблона движка викторины {{templateName}} записаны в консоль.',
    'pageTemplateEditor.toast.draftRestoredTitle': 'Черновик восстановлен',
    'pageTemplateEditor.toast.draftRestoredDescriptionNew': 'Ваш несохраненный черновик нового шаблона движка викторины загружен.',
    ...
    'pageTemplates.explore.useThisTemplate': 'Использовать этот движок',
    'pageTemplates.explore.preview': 'Редактировать шаблон движка',
    'pageTemplates.explore.duplicate': 'Дублировать движок',
    'pageTemplates.explore.noTemplates.title': 'Доступных шаблонов движков викторин пока нет',
    'pageTemplates.explore.noTemplates.description': 'Станьте первым, кто создаст потрясающий шаблон движка викторины для QuizSmith!',
    'pageTemplates.explore.noTemplates.button': 'Создать свой первый шаблон движка викторины',
    ...
    'adminPanel.storage.firestore.privateKeyPlaceholder': 'Вставьте сюда JSON приватного ключа вашего сервисного аккаунта Firebase Firebase...',
    ...
    'questionType.categorization-drag-and-drop': 'Категоризация (Перетаскивание)',
    'questionType.connect-points-matching': 'Соединение точек (Сопоставление)',
  },
};
