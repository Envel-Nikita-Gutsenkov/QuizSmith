...
const translations: Translations = {
  en: {
    ...
    'pageTemplates.explore.pageTitle': 'Explore Quiz Engine Templates', 
    ...
    'adminPanel.testVersions.title': 'Test Version Management',
    'adminPanel.testVersions.description': 'Review and revert tests to their previous saved states. (Placeholder UI)',
    'adminPanel.testVersions.testNameLabel': 'Test Name',
    'adminPanel.testVersions.versionLabel': 'Version',
    'adminPanel.testVersions.savedAtLabel': 'Saved At',
    'adminPanel.testVersions.actionsLabel': 'Actions',
    'adminPanel.testVersions.currentBadge': 'Current',
    'adminPanel.testVersions.rollbackButton': 'Rollback to this version',
  ...
  ru: {
    ...
    'dashboard.myTests.description': 'Начните с создания вашего первого шедевра!',
    'dashboard.myTests.button': 'Создать первый тест',
    ...
    'dashboard.myPageTemplates.description': 'Создавайте многоразовые дизайны и движки для ваших викторин.',
    ...
    'pageTemplates.explore.pageTitle': 'Обзор шаблонов движков викторин', 
    ...
    'adminPanel.testVersions.title': 'Управление версиями тестов',
    'adminPanel.testVersions.description': 'Просмотр и откат тестов к предыдущим сохраненным состояниям. (Заглушка интерфейса)',
    'adminPanel.testVersions.testNameLabel': 'Название теста',
    'adminPanel.testVersions.versionLabel': 'Версия',
    'adminPanel.testVersions.savedAtLabel': 'Сохранено',
    'adminPanel.testVersions.actionsLabel': 'Действия',
    'adminPanel.testVersions.currentBadge': 'Текущая',
    'adminPanel.testVersions.rollbackButton': 'Откатить к этой версии',
